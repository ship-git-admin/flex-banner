...
class Flex_Banner_Meta_Box
{
  ...
  public function enqueue_admin_scripts($hook)
  {
    ...
    wp_enqueue_script('fb-admin-js', FB_PLUGIN_URL . 'assets/js/admin.js', array('jquery', 'jquery-ui-sortable'), '2.4.6', true);
    wp_enqueue_style('fb-admin-css', FB_PLUGIN_URL . 'assets/css/admin.css', array(), '2.4.6');
